...
const AUGMENT_PICK_HINTS = {
  ...
  oracle: 8, prison: 2, permaBlock: 8, battleRing: -4, chaos: -8,
  capture: 8, roleSwap: -2, checkerboard: -6, timeCollapse: 4, ward: 2,
  banZone: 6, undo: 6, territory: 4, squareFrame: 2,
  ...
  survivor: 2, counterWatch: 2, fog: 0, foresight: 4, brink: 2,
  appraisal: 4, discard: 0, nozdormu: -2, pokerFace: 2, gambleMixed: 6, gamblePrism1: -8,
  dungapsul: 2, dokkaebibul: 4,
};
