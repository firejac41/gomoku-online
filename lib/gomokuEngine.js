...
export const ONLINE_ONLY_IDS = ["fog", "dobal"];
...
export const AUGMENTS = [
  ...
  { id: "dobal", name: "도발", desc: "온라인 전용 · 1회 사용\n상대의 다음 3턴 동안\n상대의 제한시간이 절반으로 줄어듦", tier: "gold", onlineOnly: true },
...
export const ONE_TIME_ABILITY_IDS = [
  ...
  "fog", "dobal", "appraisal", "discard", "pokerFace", "timeCollapse", "ward",
  "reflectShield",
];
