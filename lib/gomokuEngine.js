...
export const AUGMENTS = [
  ...
  { id: "dungapsul", name: "둔갑술", desc: "온라인 전용 · 즉시 발동\n이후 내가 새로 얻는 증강 카드마다 자동으로 상대 화면에서만\n같은 등급의 다른 카드로 이름·설명이 위장됨(매 증강 선택마다 반복)\n(내 화면엔 그대로, 실제 효과·소유권은 진짜 카드 그대로. 둔갑술 자기 자신은 위장 안 됨)", tier: "silver", onlineOnly: true },
