...
export const ONLINE_ONLY_IDS = ["fog", "cunning", "dungapsul"];
...
export const ENHANCEABLE_AUGMENT_IDS = [
  "banZone", "watchtower", "balance", "lateBloomer", "counterWatch", "stockpile", "brink",
];
...
export const AUGMENTS = [
  ...
  },
  {
    id: "appraisal",
    name: "감정",
    desc: "1회 사용\n보유한 증강 중 강화 가능한 카드 하나를 강화판(이름+)으로 교체\n(금지 구역·감시탑·균형·늦둥이·역감시·축적·벼랑 끝만 가능)",
    tier: "gold",
  },
  { id: "discard", name: "파기", desc: "1회 사용\n보유한 증강 카드 하나를 버리고 같은 등급의 새 카드로 교체", tier: "silver" },
  { id: "dungapsul", name: "둔갑술", desc: "온라인 전용 · 1회 사용\n내 보유 카드 하나를 지정하면 이번 판 동안\n상대 화면에서만 같은 등급의 다른 카드로 이름·설명이 위장됨\n(내 화면엔 그대로, 실제 효과·소유권은 진짜 카드 그대로)", tier: "silver", onlineOnly: true },
  ...
  },
  {
    id: "cunning",
    name: "커닝",
    desc: "온라인 전용\n획득 즉시 발동, 게임 끝까지 유지\n상대가 증강을 고르는 중일 때 그 선택지 카드 내용이 나에게만 보임",
    tier: "silver",
    onlineOnly: true,
  },
  {
    id: "trickleDown",
    name: "낙수효과",
    desc: "자동 발동 (1회)\n상대가 잠복·역감시·생존자·벼랑 끝 중 하나로\n무료 카드를 처음 획득하는 순간, 나도 무작위 실버 카드 1장을 함께 획득",
    tier: "silver",
  },
  {
    id: "lifeTransfer",
    name: "인생환승",
    desc: "1회 사용\n보유한 실버 등급 카드 하나를 선택하면\n그 카드를 버리고 무작위 골드 등급 카드로 교체",
    tier: "gold",
  },
  {
    id: "reverseScale",
    name: "역린",
    desc: "1회 사용\n내 돌 하나를 지정 (양쪽에 다 보임)\n상대가 그 돌의 8방향 인접 칸에 처음 두면\n그 즉시 그 수가 무효화됨",
    tier: "gold",
  },
  {
    id: "karma",
    name: "인과응보",
    desc: "내 돌이 상대의 제거 계열 효과로 누적 3번째 제거당하는 순간(1회)\n그 즉시 상대의 돌 무작위 3개가 제거됨\n(상대의 면역은 각각 정상 적용)",
    tier: "prism",
  },
  {
    id: "dokkaebibul",
    name: "도깨비불",
    desc: "상시 반복 (소모 없음)\n상대의 제거 계열 효과(포위 제거·오델로·습격·돌 제거·역병·붕괴·인과응보)가\n내 돌을 제거하려 할 때마다, 대상 하나하나가 독립적으로 30% 확률로 그 시도를 피함\n(철옹성·부적·대비태세·여진·예방을 전부 통과한 뒤 마지막으로 확인되는 최후의 저항선)",
    tier: "gold",
  },
];
...
export const ONE_TIME_ABILITY_IDS = [
  ...
  "fog", "appraisal", "discard", "dungapsul", "pokerFace", "timeCollapse", "ward",
  "reflectShield",
  "trickleDown", "lifeTransfer", "reverseScale", "karma",
];
