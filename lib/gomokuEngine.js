...
const ENHANCED_DESCRIPTIONS = {
  banZone: "선택한 3칸, 상대는 3턴(강화) 동안 착수 금지",
  watchtower: "1회 사용 - 빈 칸 1곳을 지정(양쪽에 다 보임). 이후 상대가 6턴(강화) 안에 그 칸에 두면 그 수가 무효화됨",
  balance: "흑돌 전용 - 내 돌이 상대보다 1개(강화) 이상 적으면, 그동안 렌주룰 금수가 면제됨",
  lateBloomer: "판 전체 총 수가 12수(강화)를 넘긴 뒤로, 내가 뽑는 실버 등급 카드는 전부 골드로 승급됨",
  noYield: "백돌 전용 - 총 4수 이내에 흑돌이 둘 때마다 25%(강화) 확률로 내 다음 턴에 보너스 착수 1회가 생김",
  counterWatch: "백돌 전용 - 흑돌이 총 10수(강화) 이내에 처음 만드는 열린 3목을 감지하면, 그 즉시 무작위 증강 카드 1장을 무료로 획득",
  stockpile: "내가 가진 증강 1개당, 다음 증강 선택에서 리롤 가능 횟수가 2회(강화)씩 늘어남",
  brink: questDesc("내 돌이 상대보다 2개(강화) 이상 적어져야 합니다(반복 발동)", "그 즉시 무료 실버 카드 1장을 획득"),
};
...
export const AUGMENTS = [
  ...
  { id: "othello", name: "오델로", desc: "돌을 놓았을 때 내 돌 사이에 상대 돌 1개가 끼어 있으면 그 돌을 내 색으로 뒤집음 (사이에 2개 이상이면 효과 없음) - 포위 제거와 함께 보유 중이면 낀 돌마다 50% 확률로 둘 중 하나가 적용됨", tier: "prism" },
  ...
  { id: "boardFlip", name: "판 뒤엎기", desc: "내가 지금까지 둔 돌을 모두 지우고, 지운 개수만큼 무작위한 빈 칸에 다시 놓음 (1회용이 아니라 재사용 대기시간 있음 - 내가 6수 둘 때마다 1번씩 다시 사용 가능, 사용하면 턴이 넘어감)", tier: "prism" },
  ...
  { id: "prison", name: "교도소", desc: "획득 즉시, 이후로 게임이 끝날 때까지 양쪽 모두의 프리즘 증강 효과가 전부 비활성화됨 (자기 자신 포함)", tier: "prism" },
  { id: "domino", name: "도미노", desc: "포위 제거나 오델로로 상대 돌을 없애면, 그 턴에 한 번 더 놓을 수 있음", tier: "prism" },
  { id: "permaBlock", name: "영구 봉쇄", desc: "선택한 칸 1개, 상대는 게임 끝까지 착수 금지", tier: "prism" },
  { id: "battleRing", name: "링 위에서 싸우자", desc: "발동 즉시 판이 4수마다 사방으로 한 겹씩 좁혀 들어가 최종 8x8까지 줄어듦 (게임 끝까지 유지, 양쪽 모두 적용). 최종 위치는 무작위로 정해지며 발동 즉시 점선으로 공개됨 - 경계 밖으로 밀려난 칸의 돌은 그 즉시 삭제됨", tier: "prism" },
  { id: "chaos", name: "폭주", desc: "발동 즉시 게임이 끝날 때까지 양쪽 모두 조작권을 잃음 - 아무 칸이나 클릭해도 무작위 빈 칸에 놓이고, 증강 액티브 능력도 전부 못 씀", tier: "prism" },
  { id: "wipeout", name: "백지화", desc: "1회 사용 - 판 위의 돌을 전부 지움 (양쪽 다, 보유 증강과 지금까지 놓은 수는 그대로 유지, 사용하면 턴이 넘어감)", tier: "prism" },
  { id: "capture", name: "포위 제거", desc: "내돌-상대돌-내돌 모양이 되면 가운데 돌 자동 제거 - 오델로와 함께 보유 중이면 낀 돌마다 50% 확률로 둘 중 하나가 적용됨", tier: "prism" },
  { id: "roleSwap", name: "입장 바꿔 생각하기", desc: "발동 즉시 게임이 끝날 때까지 나와 상대가 서로 담당하는 돌 색이 뒤바뀜 (흑돌이던 사람은 이제 백돌을, 백돌이던 사람은 이제 흑돌을 둠 - 승리 조건도 그 색을 따라 함께 바뀜. 단, 렌주룰은 신원이 아니라 지금 흑돌을 두는 사람 기준으로 그대로 적용됨)", tier: "prism" },
  { id: "banZone", name: "금지 구역", desc: "선택한 3칸, 상대는 2턴 동안 착수 금지", tier: "gold" },
  { id: "undo", name: "되돌리기", desc: "상대의 마지막 수를 무르기 (1회, 원할 때 사용)", tier: "gold" },
  { id: "territory", name: "영역 점령", desc: "중앙 5x5에 내 돌 13개 이상(절반 이상)이면 승리", tier: "gold" },
  ...
  { id: "barter", name: "거래", desc: "1회 사용 - 내가 아직 안 쓴 1회용 증강 효과를 전부 포기하고, 그 대신 프리즘 등급 증강 1개를 무작위로 즉시 획득", tier: "gold" },
  ...
  { id: "raid", name: "습격", desc: "상대가 이 판에서 처음으로 열린 3목을 만드는 순간, 그 즉시 자동으로 상대 돌 무작위 2개가 제거됨 (버튼 없이 자동 발동, 1회)", tier: "gold" },
  { id: "relocate", name: "재배치", desc: "내 돌 1개를 골라 인접한 빈 칸으로 옮김 (1회용이 아니라 재사용 대기시간 있음 - 내가 6수 둘 때마다 1번씩 다시 사용 가능, 사용하면 턴이 넘어감)", tier: "gold" },
  { id: "lockdown", name: "봉인", desc: "1회 사용 - 상대의 아직 안 쓴 1회용 증강 효과를 이번 판 동안 전부 봉인", tier: "gold" },
  ...
  { id: "adjacentLink", name: "연속 배치", desc: "직전에 내가 둔 돌 바로 옆(가로·세로·대각선 중 한 방향)에 이어서 놓으면, 실제로는 2개뿐이어도 3개를 이은 것처럼 쳐줌 (그 방향으로 +1칸 보너스)", tier: "silver" },
  { id: "peek", name: "먼저 보기", desc: "다음 증강 선택 때 나올 카드 1장을 지금 미리 확정하고 확인함 (그 카드가 다음 선택지 3장 중 하나로 반드시 포함됨)", tier: "silver" },
  { id: "doubleChoice", name: "추가 선택", desc: "다음 증강 선택 시 3장 대신 4장 중에서 선택", tier: "silver" },
  { id: "selfUndo", name: "직전 무르기", desc: "내 마지막 수를 스스로 무르고 다시 두기 (1회용이 아니라 재사용 대기시간 있음 - 내가 4수 둘 때마다 1번씩 다시 사용 가능)", tier: "silver" },
  { id: "threatRadar", name: "위험 감지", desc: "내 턴에 상대의 승리 자리를 강조 표시", tier: "silver" },
  { id: "removeStone", name: "돌 제거", desc: "상대 돌 1개를 제거 (1회용이 아니라 재사용 대기시간 있음 - 내가 5수 둘 때마다 1번씩 다시 사용 가능, 사용하면 내 턴이 넘어감)", tier: "silver" },
  { id: "attrition", name: "물량전", desc: "보드가 완전히 다 찼을 때 내 돌이 상대보다 많으면 즉시 승리 (무승부 방지용)", tier: "silver" },
  { id: "coinFlip", name: "동전 던지기", desc: "1회 사용 - 50% 확률로 무작위 증강 1개 즉시 획득, 50% 확률로 다음 증강 선택을 건너뜀", tier: "silver" },
  { id: "leverage", name: "저울질", desc: "1회 사용 - 내 증강 수가 상대보다 적을 때만 사용 가능. 다음 증강 선택에서 상대가 이미 가진 증강은 선택지에서 제외됨", tier: "silver" },
  { id: "gamble", name: "도박", desc: "선택 즉시 [실버 2개 + 골드 1개 획득] 또는 [45% 확률로 프리즘 1개 획득, 실패하면 아무것도 못 얻음] 중 하나를 고름. 대신 다음 증강 선택 2번을 건너뜀", tier: "silver" },
  ...
  { id: "balance", name: "균형", desc: "흑돌 전용 - 내 돌이 상대보다 2개 이상 적으면, 그동안 렌주룰 금수가 면제됨", tier: "silver", colorOnly: 1 },
  { id: "jailbreak", name: "도장깨기", desc: "상대가 나에게 걸어둔 금지 구역·영구 봉쇄·감시탑 중 하나를 지정해서 즉시 해제 (1회용이 아니라 재사용 대기시간 있음 - 내가 5수 둘 때마다 1번씩 다시 사용 가능)", tier: "silver" },
  ...
  { id: "stockpile", name: "축적", desc: "내가 가진 증강 1개당, 다음 증강 선택에서 리롤 가능 횟수가 1회씩 늘어남", tier: "silver" },
  { id: "ambush", name: "잠복", desc: "상대의 금지 구역·영구 봉쇄·감시탑에 처음 걸리는 순간, 그 즉시 무작위 증강 카드 1장을 무료로 획득", tier: "silver" },
  {
    id: "survivor",
    name: "생존자",
    desc: questDesc("내 돌이 이 판에서 처음 제거당해야 합니다(포위 제거·습격·돌 제거·역병·붕괴)", "그 즉시 무료 실버 카드 2장을 획득"),
    tier: "silver",
    quest: true,
  },
  { id: "counterWatch", name: "역감시", desc: "백돌 전용 - 흑돌이 총 8수 이내에 처음 만드는 열린 3목을 감지하면, 그 즉시 무작위 증강 카드 1장을 무료로 획득", tier: "silver", colorOnly: 2 },
  { id: "noYield", name: "양보 없음", desc: "백돌 전용 - 총 4수 이내에 흑돌이 둘 때마다 15% 확률로 내 다음 턴에 보너스 착수 1회가 생김", tier: "gold", colorOnly: 2 },
  { id: "fog", name: "안개", desc: "1회 사용 - 상대 턴 기준 3턴 동안 상대 화면에서만 보드 외곽 2줄이 안개로 가려짐 (온라인 전용)", tier: "silver", onlineOnly: true },
  { id: "foresight", name: "예지", desc: "상대가 다음에 두면 열린 3목이 되는 빈 칸을 미리 강조 표시", tier: "gold" },
  {
    id: "checkerboard",
    name: "체크무늬",
    desc: "발동 즉시 게임이 끝날 때까지 (x+y) 좌표 합이 짝수인 칸만 착수 가능해짐 (가로/세로 5목은 불가능해지고 대각선 방향만 승리 가능) - 대각선 강화·일자진과는 함께 나오지 않음",
    tier: "prism",
  },
  {
    id: "brink",
    name: "벼랑 끝",
    desc: questDesc("내 돌이 상대보다 3개 이상 적어져야 합니다(반복 발동)", "그 즉시 무료 실버 카드 1장을 획득"),
    tier: "gold",
    quest: true,
  },
  {
    id: "appraisal",
    name: "감정",
    desc: "1회 사용 - 보유한 증강 중 강화 가능한 카드 하나를 선택해 강화판(이름+)으로 교체 (금지 구역·감시탑·균형·늦둥이·양보 없음·역감시·축적·벼랑 끝만 강화 가능)",
    tier: "gold",
  },
  { id: "discard", name: "파기", desc: "1회 사용 - 보유한 증강 카드 하나를 버리고 같은 등급의 새 카드로 교체", tier: "silver" },
  { id: "nozdormu", name: "노즈도르무", desc: "선택 즉시 게임이 끝날 때까지 양쪽 모두의 제한시간이 15초로 고정됨", tier: "gold" },
  {
    id: "pokerFace",
    name: "포커페이스",
    desc: "1회 사용 - 사용하면 상대에게는 정체를 알 수 없는 경고만 뜨고, 나에게만 이번이 진짜인지 가짜인지 바로 알려줌. 33% 확률로 진짜면 3턴 뒤 상대가 아직 쓰지 않은 실버·골드 등급 카드 중 무작위 1장을 강탈함 (가짜면 3턴 뒤 아무 일 없이 조용히 사라짐)",
    tier: "gold",
  },
  {
    id: "timeCollapse",
    name: "시공간 붕괴",
    desc: "획득하는 순간 지금 이 시점의 보드를 저장해두고, 게임 중 아무 때나 1회 그 시점으로 판을 되돌림 (양쪽 돌 전부 대상, 지금까지 놓은 수와 보유 증강은 그대로 유지, 사용하면 턴이 넘어감)",
    tier: "prism",
  },
  {
    id: "ward",
    name: "결계",
    desc: "1회 사용 - 판 위의 두 칸을 지정(가로/세로/대각선으로 일직선이어야 함). 그 사이에 있는 빈 칸들이 게임 끝까지 양쪽 모두 착수 금지가 됨",
    tier: "prism",
  },
  {
    id: "prepStance",
    name: "대비태세",
    desc: "사용하면 즉시 방어막이 생겨서 다음번 제거·봉쇄 계열 공격 1회를 자동으로 막아줌 (부적과 같은 방식이지만, 원하는 타이밍에 직접 켤 수 있고 재사용 가능) - 재사용 대기시간 있음(5수), 사용해도 턴은 안 넘어감",
    tier: "silver",
  },
  {
    id: "prevention",
    name: "예방",
    desc: "내 돌 하나를 지정 - 그 돌은 포위 제거나 돌 제거로 사라질 위기에서 1회 보호됨 (여진처럼 무작위 자동이 아니라, 어떤 돌을 지킬지 직접 고를 수 있음) - 재사용 대기시간 있음(6수)",
    tier: "gold",
  },
  {
    id: "interest",
    name: "이자",
    desc: "내 돌이 제거되거나 내가 금지 구역·영구 봉쇄·감시탑에 실제로 걸릴 때마다, 다음 증강 선택 등급이 한 단계 상승함(누적, 실버→골드→프리즘)",
    tier: "gold",
  },
  {
    id: "backlash",
    name: "역풍",
    desc: "면역(철옹성·부적·대비태세)이나 여진·예방으로 상대의 제거 공격을 막아내면, 그 공격에 쓰인 카드가 재사용 대기시간(쿨다운) 방식일 때 그 카드의 대기시간이 2배로 늘어남",
    tier: "gold",
  },
  {
    id: "reflectShield",
    name: "역장",
    desc: "나에게 금지 구역·영구 봉쇄·감시탑이 누적 3번째로 걸리는 순간(1회), 그때 나에게 걸려있는 모든 금지 구역·영구 봉쇄·감시탑이 전부 무효화되고 그대로 상대에게 반사됨",
    tier: "prism",
  },
];
...
export const GAMBLE_OPTIONS = [
  { id: "gambleMixed", name: "실버 2개 + 골드 1개 획득", desc: "무작위 실버 증강 2개 + 골드 증강 1개를 즉시 획득. 대신 다음 증강 선택 2번을 건너뜀", tier: "gold" },
  { id: "gamblePrism1", name: "프리즘 1개 획득 (45%)", desc: "45% 확률로 무작위 프리즘 증강 1개 획득, 실패하면 아무것도 못 얻음. 어느 쪽이든 다음 증강 선택 2번을 건너뜀", tier: "prism" },
];
