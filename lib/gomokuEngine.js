...
export const AUGMENTS = [
  ...
  { id: "squareFrame", name: "네모", desc: "보드 아무 곳에나 가로세로 4칸짜리 네모 테두리를 완성하면 즉시 승리", tier: "gold" },
  { id: "attrition", name: "물량전", desc: "보드가 완전히 다 찼을 때 내 돌이 상대보다 많으면 즉시 승리 (무승부 방지용)", tier: "gold" },
  { id: "awakening", name: "각성", desc: "판 전체 총 수가 20수를 넘기고도 안 끝나면, 그때부터 대각선 강화와 일자진 효과가 자동으로 같이 적용됨", tier: "prism" },
  { id: "coinFlip", name: "동전 던지기", desc: "1회 사용 - 50% 확률로 무작위 증강체 1개 즉시 획득, 50% 확률로 다음 드래프트를 건너뜀", tier: "silver" },
  { id: "bind", name: "속박", desc: "1회 사용 - 상대의 다음 턴을 통째로 건너뜀", tier: "prism" },
  { id: "stinginess", name: "인색", desc: "1회 사용 - 상대의 다음 드래프트 선택지를 1장 줄임", tier: "gold" },
  ...
  { id: "leverage", name: "저울질", desc: "1회 사용 - 내 증강체 수가 상대보다 적을 때만 사용 가능. 다음 드래프트에서 상대가 이미 가진 증강체는 선택지에서 제외됨", tier: "silver" },
];
